...
Cohesion: 0.35
Nodes (10): cms_admin_interface_exposes_workbench_handlers(), cms_category_delete_conflicts_when_posts_exist(), cms_cli_dispatch_supports_page_list(), cms_page_domain_exposes_overview_and_status_helpers(), cms_post_domain_exposes_overview_and_status_helpers(), cms_post_list_category_query_filters_rows(), cms_public_page_route_hides_draft_content(), cms_public_post_detail_hides_draft_posts() (+2 more)
