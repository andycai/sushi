...
## Corpus Check
- 114 files · ~134,295 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1778 nodes · 3788 edges · 103 communities detected
...
Cohesion: 0.02
Nodes (150): A(), ae(), ai(), an(), ao(), ar(), At(), be() (+142 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (74): init(), onSubmitEnd(), badgeTone(), init(), loadLogs(), closeDelete(), closeEditor(), init() (+66 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (118): _(), D(), ownKeys(), raw(), T(), Ur(), r(), $() (+110 more)
...
Cohesion: 0.06
Nodes (36): create_plugin_dir(), create_plugin_dir_with_manifest(), LuaPlugin, normalize_static_url_prefix(), page_assets_fail_when_file_missing(), page_assets_resolve_bundle_then_page_assets(), parse_entry_policy(), parse_entry_public() (+28 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (20): admin_page_assets_are_stored_and_returned(), AdminHandlerBinding, api_route_policy_matches_wildcard_for_concrete_path(), ApiHandlerBinding, call_api_handler_matches_wildcards(), CliHandlerBinding, db_permission_name(), dispatch_api_handler_forwards_dispatch_path_and_binary_body() (+12 more)
...
Cohesion: 0.31
Nodes (19): get(), bindDelegatedEvents(), createDir(), createText(), deleteEntry(), download(), fetchText(), goToParent() (+11 more)
...
- **Why does `add()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 18`, `Community 27`?**
